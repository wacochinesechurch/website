# Source captions — wacochinesechurch.org/church-life

These 14 captions were published by the church on its own Church Life page,
transcribed verbatim (Simplified Chinese as written). The image files in this
directory were downloaded from the same page, but the caption↔image pairing
returned by the scraper was NOT reliable, so each pairing must be confirmed by
looking at the photograph. Filenames in this directory are provisional.

1. 少年们的退修会：敬拜，反思，培养团队协同合作能力
   Retreat: to worship, reflect, and cultivate collaborative spirit among children.

2. 职青团契的退修会。 Galveston, 盛产螃蟹，你懂的。
...
8. 丰收的季节是分享稀罕蔬菜的季节。中国特色的蔬菜，很抢手。
   Harvest time is also the opportunity to distribute vegetables that are not common in the US.

9. 2023中秋节新老朋友在华人教会欢聚一堂
