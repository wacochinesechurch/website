...
Set `draft: true` while you are still writing. Set `featured: true` to pin it
to the top of the upcoming list and onto the homepage.

`EXAMPLE-*.md` files are templates. They are drafts and never appear on the
site — copy one, rename it, and delete the EXAMPLE prefix.
